namespace AC_Career_Mode
{
    internal static class GlobalVars
    {
        ...
        internal static string TracksBin = @".\bins\ACTracks.bin";
        internal static string RacesBin = @".\bins\ACRaces.bin";
        internal static string CarsBin = @".\bins\ACCars.bin";

        internal static string DailyCarBin = @".\bins\Market.bin";
    }
}
